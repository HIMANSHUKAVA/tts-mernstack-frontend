import { AppBar, Box, Button, Drawer, IconButton,  List,  ListItem,  ListItemAvatar,  ListItemButton,  ListItemIcon,  ListItemText,  Toolbar, Typography } from '@mui/material'
...
export default function Persistancedrawer() {
  ...
  return (
    ...
    <Drawer  open={count} onClose={()=>{setcount(false)}} >
     ...
     <Typography variant='h5'>Let's Start Coding</Typography>
    </>
  )
}
